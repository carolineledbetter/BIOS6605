...
**Important Concepts:**   
  ...
  2.	The contents in the first column are all unique values.  
  3.	You can always tell R explicitly whether or not you have a header by 
      specifying the optional argument header=TRUE or header=FALSE to the read.table 
      function.  
  4.	If your file does not have a header line, R will use the default variable
