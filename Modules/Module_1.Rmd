...
list. However because dataframes can contain lists - different types of data 
...
it must be done seperatly. Data frames are created with the function 
data frame()
...
Data frames can also be created by specifing object names. 
```{r}
Age <- c(25L, 30L, 56L)
...
seperately. The levels of a factor can be accessed with the levels funtion. 
Examples:
...
mathmatical operations to be performed. 
